...
| `SigmaRule` | A detection rule (`title`, `id`, `logsource`, `detection`, `condition`, …). |
...
| Linter (`lint::*`) | 66 spec-conformance checks. See [Lint Rules reference](../reference/lint-rules.md). |
