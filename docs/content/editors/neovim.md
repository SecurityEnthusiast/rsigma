...
Zed supports configuring a language server directly from `settings.json` (see [Configuring Languages](https://zed.dev/docs/configuring-languages)). Add the server in your `settings.json`:
