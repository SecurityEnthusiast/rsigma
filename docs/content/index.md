...
::: grids
::: grid
::: card "detection.studio" icon:flask-conical
...
[Source on GitHub](https://github.com/northsh/detection.studio)
:::
:::
::: grid
::: card "Rustinel" icon:shield
...
[Source on GitHub](https://github.com/Karib0u/rustinel)
:::
:::
:::
