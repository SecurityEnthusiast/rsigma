...
| `SinkFormat` | The non-exhaustive wire format a line-oriented sink serializes into (`Ndjson`, the default). Set with `StdoutSink::with_format` and its siblings; `Sink::format` reports it. |
