...
interop_test!(
    "REQ-3.15-C-01",
    "use_cases::opinion::consumer::supports_producer_props",
...
interop_test!(
    "REQ-3.15-C-02",
    "use_cases::opinion::consumer::receives_triad",
    receives_triad,
    {
...
interop_test!(
    "REQ-3.15-C-03",
    "use_cases::opinion::consumer::resolves_created_by_ref",
...
interop_test!(
    "REQ-3.15-C-04",
    "use_cases::opinion::consumer::processes_fields",
    processes_fields,
    {
...
interop_test!(
    "REQ-3.15-C-05",
    "use_cases::opinion::consumer::processes_related",
    processes_related,
    {
...
interop_test!(
    "REQ-CHK-SXC-3.15",
    "use_cases::opinion::consumer::handles_producer_testcases",
