...
pub(crate) const CREATION_FIXTURES: &[&str] = &[FIXTURE_CREATE_INDICATOR, FIXTURE_CREATE_SIGHTING];
pub(crate) const MODIFICATION_FIXTURES: &[&str] = &[FIXTURE_MOD_INDICATOR, FIXTURE_MOD_SIGHTING];
pub(crate) const REVOCATION_FIXTURES: &[&str] = &[FIXTURE_REV_INDICATOR, FIXTURE_REV_SIGHTING];
