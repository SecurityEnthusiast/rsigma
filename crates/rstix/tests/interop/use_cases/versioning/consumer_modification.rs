...
use crate::use_cases::versioning::{FIXTURE_MOD_SIGHTING, MODIFICATION_FIXTURES};
...
pub fn assert_receives_content() {
    ...
    let bundle = validate_interop_fixture(relative, &fixture.json).unwrap();
    assert!(
        bundle.objects_of_type::<Indicator>().count()
    ...
    for relative in MODIFICATION_FIXTURES {
        ...
        for object_id in use_case_ids {
            ...
            let created_by = match wire.get("type").and_then(Value::as_str) {
                Some("indicator") => bundle
                    .get_typed::<Indicator>(&stix_id)
                    .unwrap()
                    .common
                    .created_by_ref
                    .clone(),
                Some("sighting") => bundle
...
interop_test!(
    "REQ-3.20-C-M-01",
    "use_cases::versioning::consumer_modification::supports_producer_props",
...
interop_test!(
    "REQ-3.20-C-M-02",
    "use_cases::versioning::consumer_modification::receives_content",
    receives_content,
    {
        assert_receives_content();
    }
);
interop_test!(
    "REQ-3.20-C-M-03",
    "use_cases::versioning::consumer_modification::resolves_created_by_ref",
...
interop_test!(
    "REQ-3.20-C-M-04",
    "use_cases::versioning::consumer_modification::processes_fields",
    processes_fields,
    {
...
interop_test!(
    "REQ-3.20-C-M-05",
    "use_cases::versioning::consumer_modification::processes_related",
    processes_related,
    {
...
interop_test!(
    "REQ-CHK-SXC-3.20-M",
    "use_cases::versioning::consumer_modification::handles_producer_testcases",
