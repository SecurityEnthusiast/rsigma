//! §3.20 Versioning modification consumer support.
...
use crate::use_cases::versioning::{MODIFICATION_FIXTURES, FIXTURE_MOD_SIGHTING};
...
pub fn assert_receives_content() {
    let relative = FIXTURE_MOD_SIGHTING;
    let fixture = load_fixture(relative);
...
interop_test!("REQ-3.20-C-M-01", "use_cases::versioning::consumer_modification::supports_producer_props", supports_producer_props, { assert_supports_producer_props(); });
interop_test!("REQ-3.20-C-M-02", "use_cases::versioning::consumer_modification::receives_content", receives_content, { assert_receives_content(); });
interop_test!("REQ-3.20-C-M-03", "use_cases::versioning::consumer_modification::resolves_created_by_ref", resolves_created_by_ref, { assert_resolves_created_by_ref(); });
interop_test!("REQ-3.20-C-M-04", "use_cases::versioning::consumer_modification::processes_fields", processes_fields, { assert_processes_fields(); });
interop_test!("REQ-3.20-C-M-05", "use_cases::versioning::consumer_modification::processes_related", processes_related, { assert_processes_related(); });
interop_test!("REQ-CHK-SXC-3.20-M", "use_cases::versioning::consumer_modification::handles_producer_testcases", handles_producer_testcases, { assert_handles_producer_testcases(); });
