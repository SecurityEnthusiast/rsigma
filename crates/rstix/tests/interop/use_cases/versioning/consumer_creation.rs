...
interop_test!(
    "REQ-3.20-C-C-01",
    "use_cases::versioning::consumer_creation::supports_producer_props",
...
interop_test!(
    "REQ-3.20-C-C-02",
    "use_cases::versioning::consumer_creation::receives_content",
    receives_content,
    {
...
interop_test!(
    "REQ-3.20-C-C-03",
    "use_cases::versioning::consumer_creation::resolves_created_by_ref",
...
interop_test!(
    "REQ-3.20-C-C-04",
    "use_cases::versioning::consumer_creation::processes_fields",
    processes_fields,
    {
...
interop_test!(
    "REQ-3.20-C-C-05",
    "use_cases::versioning::consumer_creation::processes_related",
    processes_related,
    {
...
interop_test!(
    "REQ-CHK-SXC-3.20-C",
    "use_cases::versioning::consumer_creation::handles_producer_testcases",
