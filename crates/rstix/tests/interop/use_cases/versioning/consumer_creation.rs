//! §3.20 Versioning creation consumer support.
...
use crate::use_cases::versioning::{CREATION_FIXTURES, FIXTURE_CREATE_SIGHTING};
...
pub fn assert_receives_content() {
    let relative = FIXTURE_CREATE_SIGHTING;
    let fixture = load_fixture(relative);
...
interop_test!("REQ-3.20-C-C-01", "use_cases::versioning::consumer_creation::supports_producer_props", supports_producer_props, { assert_supports_producer_props(); });
interop_test!("REQ-3.20-C-C-02", "use_cases::versioning::consumer_creation::receives_content", receives_content, { assert_receives_content(); });
interop_test!("REQ-3.20-C-C-03", "use_cases::versioning::consumer_creation::resolves_created_by_ref", resolves_created_by_ref, { assert_resolves_created_by_ref(); });
interop_test!("REQ-3.20-C-C-04", "use_cases::versioning::consumer_creation::processes_fields", processes_fields, { assert_processes_fields(); });
interop_test!("REQ-3.20-C-C-05", "use_cases::versioning::consumer_creation::processes_related", processes_related, { assert_processes_related(); });
interop_test!("REQ-CHK-SXC-3.20-C", "use_cases::versioning::consumer_creation::handles_producer_testcases", handles_producer_testcases, { assert_handles_producer_testcases(); });
