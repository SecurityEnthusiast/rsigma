...
use crate::use_cases::versioning::{FIXTURE_REV_SIGHTING, REVOCATION_FIXTURES};
...
interop_test!(
    "REQ-3.20-C-R-01",
    "use_cases::versioning::consumer_revocation::supports_producer_props",
...
interop_test!(
    "REQ-3.20-C-R-02",
    "use_cases::versioning::consumer_revocation::receives_content",
    receives_content,
    {
...
interop_test!(
    "REQ-3.20-C-R-03",
    "use_cases::versioning::consumer_revocation::resolves_created_by_ref",
...
interop_test!(
    "REQ-3.20-C-R-04",
    "use_cases::versioning::consumer_revocation::processes_fields",
    processes_fields,
    {
...
interop_test!(
    "REQ-3.20-C-R-05",
    "use_cases::versioning::consumer_revocation::processes_related",
    processes_related,
    {
...
interop_test!(
    "REQ-CHK-SXC-3.20-R",
    "use_cases::versioning::consumer_revocation::handles_producer_testcases",
