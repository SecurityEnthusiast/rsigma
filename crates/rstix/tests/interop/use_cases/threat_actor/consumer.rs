...
pub fn assert_processes_related() {
    ...
    assert!(
        bundle
            .get_typed::<Campaign>(&relationships[0].source_ref)
            .is_some()
    );
    assert!(
        bundle
            .get_typed::<ThreatActor>(&relationships[0].target_ref)
            .is_some()
    );
}
...
interop_test!(
    "REQ-3.18-C-01",
    "use_cases::threat_actor::consumer::supports_producer_props",
...
interop_test!(
    "REQ-3.18-C-02",
    "use_cases::threat_actor::consumer::receives_triad",
    receives_triad,
    {
...
interop_test!(
    "REQ-3.18-C-03",
    "use_cases::threat_actor::consumer::resolves_created_by_ref",
...
interop_test!(
    "REQ-3.18-C-04",
    "use_cases::threat_actor::consumer::processes_fields",
    processes_fields,
    {
...
interop_test!(
    "REQ-3.18-C-05",
    "use_cases::threat_actor::consumer::processes_related",
    processes_related,
    {
...
interop_test!(
    "REQ-CHK-SXC-3.18",
    "use_cases::threat_actor::consumer::handles_producer_testcases",
